...
- 深入研读官方教程<a href="https://www.hiascend.com/zh/ascend-c?utm_source=cann&amp;utm_medium=article&amp;utm_campaign=alll" target="_blank">《Ascend C编程指南（官方教程）》</a>，系统掌握更深入的算子开发方法，并结合算子开发工具的中高级功能进行开发。   
