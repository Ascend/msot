...
工具扩展SDK：介绍msTX打点接口。可以自定义采集时间段或者关键函数的开始和结束时间点，识别关键函数或迭代等信息，对性能和算子问题快速定界。接口详细介绍请参见《[工具扩展SDK msTX](https://gitcode.com/Ascend/mstx/blob/master/docs/zh/api_reference/mstx_api_reference.md)》。
